...
public class DragonsEyeItem extends JeanModElements.ModElement {
	@ObjectHolder("jean:dragons_eye")
	public static final Item block = null;

	public DragonsEyeItem(JeanModElements instance) {
		super(instance, 22);
	}
